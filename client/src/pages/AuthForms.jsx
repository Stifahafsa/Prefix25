...
function LoginForm({ showPassword, setShowPassword, switchToRegister }) {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        setToast({ message: err.response?.data?.message || "Erreur lors de la connexion.", type: "error" });
  ...
  switchToLogin,
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        setToast({ message: err.response?.data?.message || "Erreur lors de l'inscription.", type: "error" });
