          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {filteredEspaces.map((espace) => (
              <tr key={espace.id} className="hover:bg-gray-50">
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{espace.id}</td>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  ...
                  {canDelete && (
                    <button onClick={() => handleDeleteClick(espace.id)} className="text-red-600 hover:text-red-900">
                      Supprimer
                    </button>
                  )}
                </td>
