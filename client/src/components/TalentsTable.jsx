          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {filteredTalents.map((talent) => (
              <tr key={talent.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{talent.nom}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{talent.domaine_artiste || "N/A"}</td>
                <td className="px-6 py-4 whitespace-nowrap">{getStatusBadge(talent.statut_talent)}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  ...
                  {canDelete && (
                    <button onClick={() => handleDeleteClick(talent.id)} className="text-red-600 hover:text-red-900">
                      Supprimer
                    </button>
                  )}
                </td>
